...
# Password validation (Django default hashing)
...
# Media files (user uploads - resumes, profile pictures)
MEDIA_URL = 'media/'
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 10,
    'EXCEPTION_HANDLER': 'jobportal.jobportal.utils.custom_exception_handler',
}
